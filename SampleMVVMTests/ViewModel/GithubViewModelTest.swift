...
class GithubViewModelTest: XCTestCase {
    ...
    func testHandleSearchButtonWithSuccess() {
        ...
        let scheduler = TestScheduler(initialClock: 0)
        let apiClient = MockAPIClient(result: .success)
        apiClient.githubRepositories = [
            GithubRepository(fullName: "testFullName",
                             stargazersCount: 100,
                             htmlUrl: "https://google.com",
                             owner: GithubRepositoryOwner(avatarUrl: "https://google.com"))]
        let viewModel = GithubViewModel(apiClient: apiClient)
